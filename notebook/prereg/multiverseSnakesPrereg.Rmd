...
In addition to the point generation method, we varied the number of points created from ___ to ___.
...
First is the number of random steps generated per known location, we ranged this from ___ to ___.
