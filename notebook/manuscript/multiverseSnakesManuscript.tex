...
High task uncertainty systems manifesting high levels of uncontrollable stochasticity, making direct diagnostic replications impractical or impossible, render the evidence from quasi-replications weaker (\citeproc{ref-peterson_self-correction_2021}{Peterson \& Panofsky, 2021}).
...
Personality and the repeatability of behaviours presents a key component of the variation when attempting to generalise (\citeproc{ref-stuber_spatial_2022}{Stuber, Carlson \& Jesmer, 2022}).
...
All four cases focus on snakes that come into conflict with humans to varying degrees, either because of the risks posed by their venom: King Cobra (\citeproc{ref-Marshall2018}{Marshall et al., 2019}, \citeproc{ref-marshall_no_2020}{2020a}), Malayan Krait (\citeproc{ref-hodges_malayan_2022}{Hodges et al., 2022}), Banded Krait (\citeproc{ref-knierim_spatial_2019}{Knierim, 2019}), or because of their appetite for domestic livestock: Burmese python (\citeproc{ref-smith_native_2021}{Smith et al., 2021}).
...
The original paper highlighted the propensity for King Cobras to leave the forest (\citeproc{ref-Marshall2018}{Marshall et al., 2019}), and the heightened movement particularly during breeding season, potentially mate searching behaviour.
...
Shelter sites along edge habitats, such as field margins and banks, appear to be suitable for nesting (also evidenced by Banded Krait nest site choice; Smith et al. (\citeproc{ref-smith_risk_2024}{2024}); Knierim (\citeproc{ref-knierim_spatial_2019}{2019})).
...
Their use of edge habitats is not limited to sheltering, as like Burmese Pythons, the edges offer suitable (possibly communal) nest sites (\citeproc{ref-knierim_spatial_2019}{Knierim, 2019}).
