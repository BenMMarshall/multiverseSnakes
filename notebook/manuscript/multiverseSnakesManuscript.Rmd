...
For land use classfication we relied on data supplied by the Land Development Department of Thailand [@land_development_department_thailand_land-use_2017].
...
Other studies have revealed OPHA nesting potentially favours less disturbed areas, even if a clear preference of forests is not apparent [@koirala_distribution_2021]. 
...
We used *here* `r paste0("v.", packageVersion("here"))` [@here], *readr* `r paste0("v.", packageVersion("readr"))` [@readr], *inborutils* `r paste0("v.", packageVersion("inborutils"))` [@inborutils], and *qs* `r paste0("v.", packageVersion("qs"))` [@qs] to manage directory addresses and saved objects.
